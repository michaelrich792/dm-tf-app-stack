...
#echo "Replace the contents of this file with the script to install and configure maven java and other components and logical to verify port 8080
...
# This will be done manually via the bastion host
